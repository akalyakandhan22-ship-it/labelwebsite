...
navbar.innerHTML=` <a class="navbar-brand mb-0" href="#">LOGO</a>
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="printed.html">Pricing</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <ul class="list-unstyled text-white-50">
                        <li class="mb-2"><i class="bi bi-telephone-fill me-2 text-white"></i> (406) 555-0120</li>
                        <li class="mb-2"><i class="bi bi-envelope-fill me-2 text-white"></i> mangcoding123@gmail.com
                        </li>
                        <li><i class="bi bi-geo-alt-fill me-2 text-white"></i> 2972 Westheimer Rd. Santa Ana, Illinois
                            85486</li>
                    </ul>
                </div>
